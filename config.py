...
if __name__ == "__main__":
    ...
    server_url = input('Please input Ollama server url (Default http://127.0.0.1:11434): ').strip() or 'http://127.0.0.1:11434'
    ...
    whisper_model_number = int(input("""
    ...
    match whisper_model_number:
        ...
        case _:
            whisper_model_name = "base"
    config['Models'] = {'model_name': model_name, 'whisper_model_name': whisper_model_name}
