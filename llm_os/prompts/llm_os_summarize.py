...
Summarize what happened in the conversation from the perspective of the AI (you MUST use the first person). Do NOT repeat the conversation history OR your persona OR just a single part of the conversation history word-for-word, SUMMARIZE THE CONVERSATION HISTORY in AS FEW WORDS AS POSSIBLE! Do NOT attempt to CONTINUE the conversation, SUMMARIZE IT!
