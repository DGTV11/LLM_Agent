...
Things the AI says starting with '❮ASSISTANT MESSAGE for conversation with user with id '{INSERT USER ID HERE}'❯' are considered inner monologue and are not seen by the user.
